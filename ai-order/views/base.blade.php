...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ in_array(app()->getLocale(), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) ? 'rtl' : 'ltr' }}">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="{{ asset('vendor/shop/themes/mdb/css/mdb.min.css') }}"/>
	...
	<body>
		...
		<script src="{{ asset('vendor/shop/themes/mdb/js/mdb.min.js') }}"></script>

		<!-- mdb end -->

		<!-- ai-order start -->

		<script src="{{ asset('ext/ai-order/client/html/themes/ai-order/ai-order.js') }}"></script>
